...
const App = () => {
  ...
  const [blocks, setBlocks] = useState([
    {
      index: 0,
      hash: "0000x892ab456ef...",
      prevHash: "00000000000000...",
      merkleRoot: "7d5a0927e123...",
      timestamp: 1706950000000,
      nonce: 45612,
      data: "Bloc Genèse",
    },
    {
      index: 1,
      hash: "0000x456cd789gh...",
      prevHash: "0000x892ab456ef...",
      merkleRoot: "1a2b3c4d5e6f...",
      timestamp: 1706950100000,
      nonce: 89233,
      data: "Transfert: 50 BTC",
    },
    {
      index: 2,
      hash: "0000x123ef012ij...",
      prevHash: "0000x456cd789gh...",
      merkleRoot: "9f8e7d6c5b4a...",
      timestamp: 1706950200000,
      nonce: 12044,
      data: "Mining Reward: 6.25 BTC",
    },
  ]);
  ...
  // Simulation Mempool avec données complètes
  useEffect(() => {
  ...
  const handleSearch = (e) => {
    ...
    const foundIndex =
      term.length < 8
        ...
        : blocks.findIndex((b) =>
            b.hash.toLowerCase().includes(term.toLowerCase()),
          );
  ...
  return (
    <div className="flex h-screen bg-slate-900 text-white overflow-hidden font-sans">
      {/* 1. SIDEBAR : MEMPOOL (AVEC ENVOYEUR ET RECEVEUR RESTAURÉS) */}
          ...
          <AnimatePresence initial={false}>
            {mempool.map((tx) => (
              ...
              >
                ...
                {/* ADRESSES RESTAURÉES ICI */}
                <div className="space-y-1.5 border-t border-slate-700/50 pt-2">
                  <div className="flex items-center gap-2 overflow-hidden">
                    <span className="text-[9px] text-slate-500 font-bold w-7">
                      FROM:
                    </span>
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-10 relative overflow-hidden">
        {/* HEADER & RECHERCHE */}
        <div className="z-20 text-center mb-10 w-full">
          ...
          <form
            ...
            className="flex w-96 mx-auto group shadow-2xl"
          >
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Rechercher Index ou Hash..."
                value={searchTerm}
        ...
        {/* 3. CARROUSEL DYNAMIQUE (CLIQUABLE) */}
          ...
          <AnimatePresence mode="popLayout" initial={false}>
            {blocks.map((block, i) => {
              ...
              return (
                ...
                >
                  <div
                    className={`text-xs font-mono mb-2 font-black ${pos === "center" ? "text-blue-200" : "text-slate-600"}`}
                  >
                  ...
                  <div
                    className={`font-black leading-none transition-all duration-500 ${pos === "center" ? "text-3xl text-white" : "text-sm text-slate-700"}`}
                  >
                    {block.data}
                  </div>
        ...
        {/* NAVIGATION BASSE */}
        <div className="mt-14 flex gap-14 z-20">
          <button
            onClick={movePrev}
            ...
            >
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-700/50">
                    <label className="text-[10px] text-green-400 font-bold block mb-1">
                      Receiver (To)
                    </label>
                    <div className="font-mono text-[10px] text-slate-300 truncate">
                      {selectedTx.to}
                ...
                <div className="bg-yellow-500/5 p-5 rounded-xl border border-yellow-500/20 flex justify-between items-center">
                  <div>
                    <label className="text-[10px] text-yellow-600 font-bold block uppercase">
                      Amount
                    </label>
                    <div className="text-2xl font-black text-white">
                      {selectedTx.amount}{" "}
                      <span className="text-sm text-yellow-500">BTC</span>
                    </div>
                  </div>
